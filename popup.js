...
document.addEventListener('DOMContentLoaded', function () {
	...
	if (bg.myID == ''){
		document.getElementById('alert').innerText = 'You need to set your SteamID in options.';
		document.getElementById('alert').style.visibility = 'visible';
		document.getElementById('notAlert').style.visibility = 'hidden';
	} else {
		var myID = bg.myID;
		document.getElementById('alert').style.visibility = 'hidden';
		document.getElementById('notAlert').style.visibility = 'visible';
